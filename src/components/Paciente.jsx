...
const Paciente = ({paciente}) => {
  ...
  return (
    <div className='mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl'>
        ...
        <p className="font-bold uppercase text-indigo-800 my-2">Email Contacto: <span className="font-normal normal-case text-black">{email}</span></p>
        <p className="font-bold uppercase text-indigo-800 my-2">Fecha Alta: <span className="font-normal normal-case text-black">{formatearFecha(fecha)}</span></p>
